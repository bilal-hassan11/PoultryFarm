        ...
        <div class="row">
          <div class="col-12 col-sm-12">
              <div class="card ">
                ...
                <div class="card-body">
                <form action="{{ route('admin.reports.medicine_item_wise_stock_report') }}" method="GET">
                              @csrf
                          <div class="row">
                            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-12 col-sm-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <center><h1 class="page-title text-primary">Medicine Item Stock Report</h1><br /></center>
                ...
                <div class="card ">
                    ...
                    <table id="example" class="text-fade table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach($purchase_medicine AS $pf)
                                <tr class="text-dark">
                                    <th>{{ @$pf->id }}</th>
                ...
                <div class="card ">
                    ...
                    <table id="example" class="text-fade table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <?php @$tot_rf_val = 0;  ?>
                            @foreach($return_medicine AS $rf)
                                <tr class="text-dark">
                                    <th>{{ @$rf->id }}</th>
                                    <th>{{date('d-M-Y', strtotime(@$rf->date))}}</th>
                                    <td> {{ @$rf->name }}</td>
                                    ...
                                    <td> {{@$rf->quantity}}</td>
                                    <?php $stock += @$rf->quantity;  ?>
                                    <?php @$tot_rf_val += @$rf->quantity ?>
                                    <td><span class="waves-effect waves-light btn btn-danger-light">{{ @$stock }} </span></td>
            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                        <h4 style="color:blue; float:right;">Closing Stock : {{@$stock}} </h4>
