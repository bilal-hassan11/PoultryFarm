        ...
        <div class="row">
          <div class="col-12 col-sm-12">
              <div class="card ">
                ...
                <div class="card-body">
                <form action="{{ route('admin.reports.feed_item_wise_stock_report') }}" method="GET">
                              @csrf
                          <div class="row">
                            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-12 col-sm-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <center><h1 class="page-title text-primary">Feed Item Stock Report</h1><br /></center>
            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                        <h4 style="color:blue; float:right;">Closing Stock : {{number_format(@$stock)}} Bags</h4>
