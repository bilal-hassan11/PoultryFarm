        ...
        <div class="row">
          <div class="col-12 col-sm-12">
              <div class="card ">
                ...
                <div class="card-body">
                <form action="{{ route('admin.reports.chick_item_wise_stock_report') }}" method="GET">
                              @csrf
                          <div class="row">
                            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-12 col-sm-12">
                <div class="card ">
                    ...
                    <div class="card-body">
                        <center><h1 class="page-title text-primary">Chick Item Stock Report</h1><br /></center>
                ...
                <div class="card ">
                    ...
                    <table id="example" class="text-fade table table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach($purchase_chick AS $pf)
                                <tr class="text-dark">
                                    <th>{{ @$pf->id }}</th>
                                    <th>{{date('d-M-Y', strtotime(@$pf->date))}}</th>
                                    <td> {{ @$pf->account->name }}</td>
                                    <td><span class="waves-effect waves-light btn btn-danger-light"> Item Name : {{ @$pf->item->name }} , Rate : {{ @$pf->rate }} , Quantity : {{ @$pf->quantity }}  </span> </td>
                                    <?php @$tot_pf_val += @$pf->quantity; ?>
                                    <?php $stock += @$pf->quantity;  ?>
                                    <td> {{ @$pf->quantity }}</td>
                                    <td>{{@$stock}}</td>
                ...
                <div class="card ">
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <?php @$tot_sf_val = 0; ?>
                            @foreach($sale_chick AS $sf)
                                <tr class="text-dark">
                                    <th>{{ @$sf->id }}</th>
                                    <th>{{date('d-M-Y', strtotime(@$sf->date))}}</th>
                                    <td> {{ @$sf->account->name }}</td>
                                    <td><span class="waves-effect waves-light btn btn-danger-light"> Item Name : {{ @$sf->item->name }} , Rate : {{ @$sf->rate }} , Quantity : {{ @$sf->quantity }}  </span> </td>
                                    <td> {{@$sf->quantity}}</td>
            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                        <h4 style="color:blue; float:right;">Closing Stock : {{number_format(@$stock)}} Chicks</h4>
