...
<img src="http://localhost/FeedSystem/public/new_assets/images/main-logo.jpeg" style="width:120px; height:120px; float:left; margin-left:18px; " alt="">
  <br />
...
<center>
  ...
  <h2 class="text-decoration-underline" style=" margin-left:58px; float:left; display:center;"> <u>Bilal Feed</u> | <u>Ledger Statement</u></h2>
    <br /><br /><br /><br /><br />
    <div>
    <img src="http://localhost/FeedSystem/public/admin_assets/images/m1.png" style="width:40px; height:40px; margin-left:-250px;" alt=""><h4 style="color:green; margin-left:-70px;">{{$account_name[0]->name}} {{$days}} Days</h4>
