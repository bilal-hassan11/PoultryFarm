        ...
        <div class="side-app">
            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.feed-invoices.sale') }}" method="GET">
                                @csrf
                                <div class="row">
                                                ...
                                                @foreach ($pending_Feed as $pending)
                                                    <tr class="text-dark">
                                                        ...
                                                        <td style="width: 15%; !important"><span
                                                                class="waves-effect waves-light btn btn-rounded btn-danger-light">{{ $pending->item->name ?? '' , abs($pending->quantity)  }}</span>
                                                        </td>
            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        <div class="card-header">
                            <h3 class="card-title mb-0">All Shades Feed Consume  Detail</h3>
                        </div>
                        <div class="card-body">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($sale_Feed as $sale)
                                                        <tr class="text-dark">
                                                            ...
                                                            <td style="width: 15%; !important"><span
                                                                    class="waves-effect waves-light btn btn-rounded btn-danger-light">{{ $sale->shade->name ?? '' }}</span>
                                                            </td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#formData").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.feed-invoices.store-sale') }}",
                    method: "POST",
                    data: formData,
