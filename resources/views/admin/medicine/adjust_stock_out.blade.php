            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.medicine-invoices.adjust_out') }}" method="GET">
                                @csrf
                                <div class="row">
                                    <div class="col-md-2">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($purchase_medicine as $purcahse)
                                                        <tr class="text-dark">
                                                            ...
                                                            <td>{{ number_format(@$purcahse->net_amount / abs(@$purcahse->quantity), 2) }}
                                                            </td>
                                                            <?php $tot_q += abs($purcahse->quantity); ?>
                                                            <td>{{ abs($purcahse->quantity) }}</td>
