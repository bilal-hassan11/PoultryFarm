            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.chick-invoices.sale') }}" method="GET">
                                @csrf
                                <div class="row">
                                            ...
                                            @foreach ($pending_Chick as $pending)
                                                <tr class="text-dark">
                                                    ...
                                                    <td style="width: 20%; !important">
                                                        ...
                                                        <a href="{{ route('admin.chick-invoices.edit.sale', ['invoice_no' => $pending->invoice_no]) }}"
                                                            title="Edit"><button
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($sale_Chick as $sale)
                                                        <tr class="text-dark">
                                                            ...
                                                            <td style="width: 20%; !important">
                                                                <a
                                                                    href="{{ route('admin.chick-invoices.sale.show', ['invoice_no' => $sale->invoice_no]) }}"><button
                                                                        class="btn btn-outline-info  rounded-pill btn-wave"
                                                                        type="button">
                                                                        <i class="ri-eye-line"></i></a>
                                                                </button>
                                                                <a href="{{ route('admin.chick-invoices.edit.sale', ['invoice_no' => $sale->invoice_no]) }}"
                                                                    title="Edit"><button
                                                                        class="btn btn-outline-info rounded-pill btn-wave mr-2"><i
                                                                            class="ri-edit-line"></i></button>
                                                                </a>
