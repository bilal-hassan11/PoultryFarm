                        ...
                        <div class="row">
                            <div class="col-md-2 mb-3">
                                ...
                                <input type="text" name="invoice_no" class="form-control"
                                    value="{{ old('invoice_no', $ChickInvoice[0]->invoice_no) }}" readonly>
                            </div>
                            <div class="col-md-2 mb-3">
                                <label for="date" class="required">Date</label>
                                <input type="date" name="date" class="form-control"
                                    value="{{ $ChickInvoice[0]->date }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="ref_no" class="form-control" placeholder="Reference No"
                                    value="{{ $ChickInvoice[0]->ref_no ?? '' }}">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label for="description" class="required">Description</label>
                                <input type="text" name="description" class="form-control" placeholder="Description"
                                    value="{{ $ChickInvoice[0]->description ?? '' }}">
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <select class="form-control select2" name="account" id="account_id">
                                    ...
                                    @foreach ($accounts as $account)
                                        <option value="{{ $account->id }}"
                                            {{ $account->id == $ChickInvoice[0]->account_id ? 'selected' : '' }}>
                                            {{ $account->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                  ...
                                  <select class="form-control select2" name="shade" id="shade_id">
                                    ...
                                    @foreach($shade as $s)
                                    <option  value="{{ $s->id }}" {{ $s->id == $ChickInvoice[0]->shade_id ? 'selected' : '' }}>{{ $s->name }}</option>
                                    @endforeach
                                  </select>
                                </div>
                            </div>
...
@section('page-scripts')
    <script type="text/javascript">
        ...
        let ChickInvoiceItems = {!! json_encode($ChickInvoice) !!};
        ...
        $(document).ready(function() {
            ...
            populateData(ChickInvoiceItems);
