                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($sale_Murghi as $sale)
                                                        <tr class="text-dark">
                                                            ...
                                                            <td style="width: 20%; !important">
                                                                <a
                                                                    href="{{ route('admin.murghi-invoices.sale.show', ['invoice_no' => $sale->invoice_no]) }}"><button
...
@section('page-scripts')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("body").on("input keyup blur", ".quantity, .saleRate, .weight, .weight_detection", function() {
                Calculation();
            });
