            ...
            <div class="row">
                <div class="col-12 col-sm-12">
                    <div class="card ">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.murghi-invoices.purchase') }}" method="GET">
                                @csrf
                                <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <table id="example54" class="text-fade table table-bordered"
                                                ...
                                                <tbody>
                                                    <?php $tot_q = 0;
                                                    $tot_amt = 0; ?>
                                                    @foreach ($purchase_Murghi as $purcahse)
                                                        <tr class="text-dark">
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group">
                                                                    <a class="btn btn-outline-info rounded-pill btn-wave mr-3"
                                                                        href="{{ route('admin.murghi-invoices.purchase.show', ['invoice_no' => $purcahse->invoice_no]) }}"
                                                                        title="View">
                                                                        <i class="ri-eye-line"></i>
                                                                    </a>
                                                                    <a class="btn btn-outline-info rounded-pill btn-wave mr-2"
                                                                        href="{{ route('admin.murghi-invoices.edit.purchase', ['invoice_no' => $purcahse->invoice_no]) }}"
                                                                        title="Edit">
                                                                        <i class="ri-edit-line"></i>
                                                                    </a>
